...
## [2.14.0 (19.09.2026)](https://github.com/thefinalcutbg/DinoDent/releases/tag/2.14.0)
...
- Добавени са допълнителни филтри при генериране на списък с пациенти, които не са използвали пакета си по НЗОК за текущата година (по предложение на <b>д-р Божидар Сойтариев</b> и <b>д-р Марин Томовски</b>)
- Добавено е предупреждение при издаване на направление за СИДП, когато пациентът е здравно неосигурен (по предложение на <b>д-р Живко Стойчев</b>)
- Добавен е предварителн изглед преди разпечатването на документите (по предложение на <b>проф. Бойко Бонев</b>)
- Добавена е възможност за запазване на справките, генерирани чрез SQL модула, като CSV файл (по предложение на <b>д-р Веселина Вангелова</b>)
- Добавена е възможност за избор на цвят на посещенията в графика (по предложение на <b>Иван Вътов</b>)
...
- При идентификатор от тип Друг полето Държава е преименувано на Националност, за да се избегне неяснота относно текущия адрес на пациента (благодарение на <b>Е. Манолов</b>)
- Отстранен е бъг, при който отметката за изпращане на покана за календарно събитие по електронна поща при записване на нов час не се визуализира (благодарение на <b>д-р Сребрина Соклева</b>)

## [2.13.0 (01.04.2026)](https://github.com/thefinalcutbg/DinoDent/releases/tag/2.13.0)
...
## [2.12.0 (07.03.2026)](https://github.com/thefinalcutbg/DinoDent/releases/tag/2.12.0)
...
## [2.11.0 (06.02.2026)](https://github.com/thefinalcutbg/DinoDent/releases/tag/2.11.0)
...
## [2.10.0 (13.01.2026)](https://github.com/thefinalcutbg/DinoDent/releases/tag/2.10.0)
...
## [2.9.1 (05.01.2026)](https://github.com/thefinalcutbg/DinoDent/releases/tag/2.9.1)

- Оправен е крашът при неуспешен опит за извличане на номер на ЗОК от ПИС (докладван от <b>д-р Сали Салиев</b>)
- Премахнато е обозначението на валутата в лв. от прозореца за редакция на артикул на финансов документ (докладван от <b>д-р Антон Козаров</b>)
