...
- Уникален идентификатор на инсталацията (UUID)
- Текуща версия на програмата
- Вид операционна система
- Брой на фигуриращите в базата данни пациенти
- Брой амбулаторни листове, пародонтални измервания, рецепти, медицински бележки, лечебни планове и финансови документи издадени от текущия потребител
- Брой амбулаторни листове на текущия потребител, регистрирани в НЗИС
...
- Дали текущият потребител използва услугите за SMS нотификации на Mobica.bg
- Дали практиката има сключен договор с НЗОК
- Дали практиката използва пен таблет за подпис от пациента и какъв модел е той
- Телефон за връзка посочен от текущия потребител
- Вид на базата данни - локална(SQLite) или сървърна(rqlite)
- Псевдонимизирани идентификатори на практиката и текущия лекар, генерирани чрез HMAC-SHA256 съответно от регистрационния код на практиката в РЗИ и ЛПК на лекаря. Оригиналните РЗИ код и ЛПК не се изпращат
- Дата и час на последното влизане в програмата
- Общ брой процедури на текущия потребител, както и брой процедури, регистрирани в НЗИС, разделени на финансирани от НЗОК и с друг източник на финансиране
...
Дата на влизане в сила: 19.09.2026
