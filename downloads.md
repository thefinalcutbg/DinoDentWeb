...
<div class="row">
  ...
  <div class="column">
     <a href="https://github.com/thefinalcutbg/DinoDent/releases/download/v2.2.0/DinoDentSetup.exe"><img src="/assets/images/win.png"></a>
  </div>
  <div class="column">
    <a href="https://github.com/thefinalcutbg/DinoDent/releases/download/v2.2.0/dinodent-macos.dmg"><img src="/assets/images/mac.png"></a>
  </div>
...
## Най-последна стабилна версия: 2.2.0 (03.01.2025)
- Премахнато е описанието на диагнозите при подаването им с месечния отчет към ПИС (подават се само МКБ кодовете)
- Добавена е функционалност за напомняния(нотификации) след определен период от време (по предложение на д-р Иван Желязков)
