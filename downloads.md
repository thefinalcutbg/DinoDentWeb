...
- Ако е активирано автоматичното извличане на данни от НЗИС, при отваряне на нов амбулаторен лист ще бъде зраден актуалния статус на зъбите за които няма записи в локалната база данни
