...
<div class="row">
  ...
  <div class="column">
     <a href="https://github.com/thefinalcutbg/DinoDent/releases/download/2.10.0/DinoDentSetup.exe"><img src="/assets/images/win.png"></a>
  </div>
  <div class="column">
    <a href="https://github.com/thefinalcutbg/DinoDent/releases/download/2.10.0/dinodent-macos.dmg"><img src="/assets/images/mac.png"></a>
  </div>
...
## Най-последна стабилна версия: 2.10.0 (13.01.2026)

- Добавени нови дентални статуси - Некариозна лезия, Дефектна обтурация, Некроза и Резорбция, съгласно обновената номенклатура в НЗИС
- Добавени шаблони за нелекарствени медикаменти при изписването на електронни рецепти
- Възможност за синхронизиране на амбулаторния лист с НЗИС. Активира се от менюто, което се отваря с десен клик върху бутона за изпращане.
- Козметични промени по графичния интерфейс
