...
- Добавена възможност за споделена база данни между няколко компютъра чрез локална мрежа или уеб сървър. Конфигурацията и поддръжката на сървъра са отговорност на крайния потребител.
