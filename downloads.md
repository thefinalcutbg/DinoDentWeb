...
- Възможност за генериране на спецификация за месечния отчет към НЗОК (по предложение на <b><i>д-р Тезей Десов</i></b>)
- Иконата на НЗИС се визуализира като безцветна при амбулаторни листове, чиито корекции не са актуализирани в НЗИС (предложено от  <b><i>Петър Първанов</i></b>)
- Възможност за въвеждане на ЛНЧ идентификатор при чуждестранни лекари регистрирани като свободна професия (предложено от <b><i>д-р Мария Михайлаки</i></b>)
- При импортиране на данни от ПИС, където е възможно, диагнозите на дейностите се преобразуват към номенклатурата за дентални диагнози в НЗИС (по предложение на <b><i>д-р Георги Славчев</i></b>)
...
Оправени бъгове:
- Оправен е бъгът при който ПИС не приема финансови документи от издател регистриран като едноличен търговец - ЕТ (докладван от <b><i>Петър Първанов</i></b>)
...
- При ръчна проверка в НАП се визуализират месеците с неплатени здравни осигуровки, дори и в момента пациентът да е здравноосигурен (предложено от <b><i>д-р Ирена Христова</b></i>)
...
Добавени функционалности:
- Добавен предварителен преглед на документите в раздел Документация (по предложение на <b><i>д-р Владимир Стефанов</b></i>)
- Добавена проверка за надвишен дневен лимит по НЗОК (по предложение на <b><i>д-р Ирена Христова</b></i>). Функциoналността е опционална, активира се от Настройки и не включва кодове 333, 832 и 833.
...
Оправени бъгове:
- Оправен е бъгът при който манипулациите от ПИС се прилагат към статуса в обратна хронология (докладван от <b><i>д-р Георги Славчев</b></i>)
...
- Проверка за наличие на активна хоспитализация (по предложение на <b><i>д-р Георги Славчев</b></i> и <b><i>д-р Нели Петрова</b></i>) и извличане на всички хоспитализации от НЗИС в раздел "Онлайн пациентско досие"
- Възможност за отчитане на частична протеза съдържаща само един зъб (микропротеза)
- Добавена съвместимост с КЕП модел карта <b>IDPrime940B</b> от StampIT (благодарности на <b><i>д-р Александър Бахнев</b></i>). За повече информация - вижте линковете в "Настройки".
...
- Зареждане на рецепти издадени през мобилното приложение eRx (по идея на <b><i>д-р Георги Славчев</b></i>)
...
- Оправен е бъгът, при който когато името на потребителя в Windows е на кирилица програмата не може да създаде правилно началната конфигурация и базата данни (благодарности на <b><i>д-р Мария Вълкова-Генчева</b></i> и на <b><i>д-р Александър Комсалов</b></i>)
- Добавено предупредително съобщение при използване на КЕП от StampIT с карта eIDAS или eIDAS 8.1 и липсващи драйвъри (благодарности на <b><i>д-р Михаела Пернишка-Бахнева</b></i>)
...
- Оправен е проблемът, при който при дисплей с висок DPI мащаб, прозорецът за онлайн пациентското досие излиза извън границите на екрана (докладван от <b><i>д-р Слави Бостанджиев</b></i>)
...
Оправени бъгове:
- Оправени са бъговете, които възникват при генериране на НЗОК отчет съдържащ амбулаторни листове на чуждестранни граждани (благодарности на <b><i>д-р Габриела Килова</b></i>)
- Оправен е бъгът при който при принтиране на направление за МДД последната цифра от ЕГН-то на пациента липсва (докладван от <b><i>д-р Силвия Граданска</b></i>)
- Оправен е бъгът при който цената на допълнителния преглед за бременни по НЗОК не се включва в предварително изчислената сума за месечния отчет (докладван на <b><i>д-р Зорница Банкова</b></i>)
...
- При наличие на няколко сертификата в КЕП-а, се използва последния добавен (благодарности на <b><i>д-р Петър Божинов</b></i>)
...
- Оправен е бъга при който прилагането на обтурация към статуса резултира в наличие на щифт (забелязан от <b><i>д-р Илия Маринов</b></i>)
