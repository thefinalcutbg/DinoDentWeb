...
<br><br>Предвидени са версии за <b>MacOS</b> и <b>Linux</b>. Ако желаете да съдействате в разработката им, вижте в раздела ["Как да помогна?"](DinoDentWeb/contribute/).

## Версия 1.0.0

<b>Инсталатор за Windows 64bit: [DinoDentSetup.exe](https://github.com/thefinalcutbg/DinoDent/releases/download/v1.0.0/DinoDentSetup.exe)</b>

Добавени функционалности: <br>
- Интеграция с Е-Дентално лечение
- Интеграция с Е-Направление (МДД4, бл.3 и бл. 3А)
- Добавени статуси - подвижно протезиране, зъбен камък и статус "неизвестен" (последнят не се изпраща към НЗИС)
