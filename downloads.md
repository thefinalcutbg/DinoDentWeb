...
<br>
<br>
<b>Изтегляне на инсталатор за Windows 10/11 64bit: [DinoDentSetup.exe](https://github.com/thefinalcutbg/DinoDent/releases/download/v1.9.0/DinoDentSetup.exe)</b>
...
- Възможност за изтегляне на амбулаторни листи и пациенти от ПИС от предишни практики в които докторът е работил (необходим е личен електронен подпис)
