...
<br>
<br>
<b>Изтегляне на инсталатор за Windows 64bit: [DinoDentSetup.exe](https://github.com/thefinalcutbg/DinoDent/releases/download/v1.5.0/DinoDentSetup.exe)</b>
...
- Добавяне на чужденци - граждани на ЕС (или по двустранни споготби)
