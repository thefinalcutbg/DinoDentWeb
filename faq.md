...
- На всеки един от комютрите инсталирате програмата с отделна база данни 
- Използвате някой от другите дентални софтуери на пазара, които поддържат такава функционалност
