...
Информацията за положения подпис може да бъде прегледана в DinoDent чрез клик върху изображението на подписа до бутона за изпращане към НЗИС и избор на раздел „Подпис“.
