...
DinoDent е насочен основно към индивидуални дентални практики. Може да се използва и в клиники, но софтуерът не е разработен с тази цел. В него няма да откриете CRM или финансови функционалности като изчисляване на заплати, справки за приходи/разходи, складова наличност и възможност за връзка с касов апарат. 
