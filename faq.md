...
Да, чрез конфигуриране на [rqlite сървър](https://rqlite.io){:target="\_blank"}, който да работи на един от компютрите в практиката (LAN/Wi-Fi режим), или на уеб сървър. Всички останали компютри се настройват да се свързват към него и така споделят една обща база данни.

<b>ВАЖНО:</b> Настройката на сървъра изисква техническа конфигурация и обикновено трябва да бъде направена от ИТ специалист. При LAN/Wi-Fi режим “сървърният” компютър трябва да е включен непракъснато. При уеб сървър се препоръчва защитен достъп (HTTPS/mTLS/VPN). Основни инструкции за конфигурация за на сървър можете да намерите [тук](/rqlite/)
