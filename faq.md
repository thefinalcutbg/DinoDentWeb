...
## Мога ли да бъде споделена базата данни между няколко компютъра свръзани с мрежа?
Не. Базата данни е вградена (embedded), и не е подходяща за използване в сървърен режим. Ако във Вашата дентална практика имате няколко компютъра свръзани в мрежа, или на всеки един от тях трябва да инсталирате програмата с отделна база данни или да използвате към някой от другите дентални софтуери, които поддържат такива функционалности.
