...
<b>ВАЖНО:</b> Настройката на сървъра изисква техническа конфигурация и обикновено трябва да бъде направена от ИТ специалист. При LAN/Wi-Fi режим “сървърният” компютър трябва да е включен непракъснато. Основни инструкции за конфигурация за на сървър можете да намерите [тук](/rqlite/)
