...
Изображението на подписа само по себе си няма юридическа стойност като електронен подпис. При подписване с пен таблет подписът на пациента се прилага към електронния XML документ, който се изпраща към НЗИС, а не към PDF файл или хартиена разпечатка. Затова поставянето на изображение на подписа върху амбулаторния лист би било технически подвеждащо и юридически некоректно.
