...
Използвайки криптографска библиотека (напр. [OpenSSL](https://openssl-library.org/){:target="\_blank"}) създавате CA сертификат, сертификат и частен ключ за сървъра и за клиента и ги настройвате. Сървърът се стартира с:
